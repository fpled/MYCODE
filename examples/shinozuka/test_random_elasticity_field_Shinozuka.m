...
mL = chol(mC); % upper triangular matrix containing the Cholesky factor of mean elasticity matrix
...
CV = randAnisotElasField(delta,mL,permute(V,[2,3,1]));
...
CW = randAnisotElasField(delta,mL,permute(W,[2,3,1]));
        ...
        case 'node'
            ...
            for i=1:n
                for j=i:n
                    iU = iU+1;
                    % Standard Shinozuka
                    figure('Name',['Gaussian field U_' num2str(i) num2str(j) ' - standard Shinozuka (order ' num2str(order) ')'],...
                        'Position',fposStd)
                    clf
                    plot_sol(S_scalar,V(:,iU,1));
                    colorbar
                    set(gca,'FontSize',fontsize)
                    mysaveas(pathname,['gaussian_field_U_' num2str(i) num2str(j) '_std_order_' num2str(order)],formats,renderer);
                    
                    % Randomized Shinozuka
                    figure('Name',['Gaussian field U_' num2str(i) num2str(j) ' - randomized Shinozuka (order ' num2str(order) ')'],...
                        'Position',fposRand)
                    clf
                    plot_sol(S_scalar,W(:,iU,1));
                    colorbar
                    set(gca,'FontSize',fontsize)
                    mysaveas(pathname,['gaussian_field_U_' num2str(i) num2str(j) '_rand_order_' num2str(order)],formats,renderer);
                end
            end
            ...
            for i=1:n
                for j=i:n
                    ...
                    plot_sol(S_scalar,V(:,iU,1));
                    colorbar
                    set(gca,'FontSize',fontsizetile)
                    title(['$U_{' num2str(i) num2str(j) '}$'],'FontSize',12,'Interpreter',interpreter)
                end
            end
            mysaveas(pathname,['gaussian_fields_std_order_' num2str(order)],formats,renderer);
            ...
            mysaveas(pathname,['gaussian_fields_rand_order_' num2str(order)],formats,renderer);
        ...
        case 'gauss'
            ...
            for i=1:n
                for j=i:n
                    iU = iU+1;
                    % Standard Shinozuka
                    figure('Name',['Gaussian field U_' num2str(i) num2str(j) ' - standard Shinozuka with order = ' num2str(order)],...
                        'Position',fposStd)
                    clf
                    ...
                    % Randomized Shinozuka
                    figure('Name',['Gaussian field U_' num2str(i) num2str(j) ' - randomized Shinozuka with order = ' num2str(order)],...
                        'Position',fposRand)
                    clf
    ...
    switch storage
        case 'node'
            for i=1:n
                for j=i:n
                    % Standard Shinozuka
                    figure('Name',['Elasticity field C_' num2str(i) num2str(j) ' - standard Shinozuka (order ' num2str(order) ')'],...
                        'Position',fposStd)
                    clf
                    ...
                    colorbar
                    set(gca,'FontSize',fontsize)
                    mysaveas(pathname,['elasticity_field_C_' num2str(i) num2str(j) '_std_order_' num2str(order)],formats,renderer);
                    
                    % Randomized Shinozuka
                    figure('Name',['Elasticity field C_' num2str(i) num2str(j) ' - randomized Shinozuka (order ' num2str(order) ')'],...
                        'Position',fposRand)
                    clf
                    ...
                    colorbar
                    set(gca,'FontSize',fontsize)
                    mysaveas(pathname,['elasticity_field_C_' num2str(i) num2str(j) '_rand_order_' num2str(order)],formats,renderer);
                end
            end
            ...
            mysaveas(pathname,['elasticity_field_std_order_' num2str(order)],formats,renderer);
            ...
            mysaveas(pathname,['elasticity_field_rand_order_' num2str(order)],formats,renderer);
        ...
        case 'gauss'
            ...
            % Standard Shinozuka
            figure('Name',['Elasticity field - standard Shinozuka with order = ' num2str(order)],...
                'Position',fposStd)
            clf
            tiledlayout(n,n);
            for i=1:n
            ...
            % Randomized Shinozuka
            figure('Name',['Elasticity field - randomized Shinozuka with order = ' num2str(order)],...
                'Position',fposRand)
            clf
            tiledlayout(n,n);
            for i=1:n
