...
if solveProblem
    ...
    [Ht,dt,ut,ft,St_phase,St] = solvePFDetLinElasAsymmetricNotchedPlateAdaptive(S,S_phase,T,CL,CR,BU,BL,BR,PU,PL,PR,sizemap,'pathname',pathname,'gmshoptions',gmshoptions,'mmgoptions',mmgoptions,'display');
...
%     u = ut{rep(end)};
    ...
    plot(S_final+ampl*u,'Color','b','FaceColor','b','FaceAlpha',0.1);
