...
switch lower(symmetry)
    case 'isotropic' % isotropic material
        filename = ['phasefieldDetLinElas' symmetry 'SingleEdgeCrack' loading PFmodel PFsplit PFregularization PFsolver initialCrack 'Adaptive'];
    case 'anisotropic' % anisotropic material
        filename = ['phasefieldDetLinElas' symmetry num2str(ang) 'deg' 'SingleEdgeCrack' loading PFmodel PFsplit PFregularization PFsolver initialCrack 'Adaptive'];
    otherwise
