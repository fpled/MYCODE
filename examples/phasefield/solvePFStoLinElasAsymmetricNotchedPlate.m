function [H_sample,d_sample,u_sample,f_sample] = solvePFStoLinElasAsymmetricNotchedPlate(S,S_phase,T,PU,PL,PR,samples,varargin)
% function [H_sample,d_sample,u_sample,f_sample] = solvePFStoLinElasAsymmetricNotchedPlate(S,S_phase,T,PU,PL,PR,samples,varargin)
...
parfor i=1:N
    ...
    [Ht,dt,ut,ft] = solvePFDetLinElasAsymmetricNotchedPlate(Si,S_phasei,T,PU,PL,PR);
