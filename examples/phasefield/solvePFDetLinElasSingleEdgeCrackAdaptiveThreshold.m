function [dt,ut,ft,T,St_phase,St,Ht] = solvePFDetLinElasSingleEdgeCrackAdaptiveThreshold(S_phase,S,T,PFsolver,BU,BL,BRight,BLeft,BFront,BBack,loading,sizemap,varargin)
% function [dt,ut,ft,T,St_phase,St,Ht] = solvePFDetLinElasSingleEdgeCrackAdaptiveThreshold(S_phase,S,T,PFsolver,BU,BL,BRight,BLeft,BFront,BBack,loading,sizemap,varargin)
