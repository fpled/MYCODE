function [dt,ut,ft,Ht,Edt,Eut,output] = solvePFDetLinElasDoubleEdgeCrack(S_phase,S,T,PFsolver,BU,BL,P,BRight,BLeft,setup,varargin)
% function [dt,ut,ft,Ht,Edt,Eut,output] = solvePFDetLinElasDoubleEdgeCrack(S_phase,S,T,PFsolver,BU,BL,P,BRight,BLeft,setup,varargin)
