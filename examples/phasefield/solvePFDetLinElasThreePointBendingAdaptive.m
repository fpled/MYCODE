function [dt,ut,ft,St_phase,St,Ht,Edt,Eut,output] = solvePFDetLinElasThreePointBendingAdaptive(S_phase,S,T,PFsolver,C,BU,BL,BR,P0,LU,initialCrack,sizemap,varargin)
% function [dt,ut,ft,St_phase,St,Ht,Edt,Eut,output] = solvePFDetLinElasThreePointBendingAdaptive(S_phase,S,T,PFsolver,C,BU,BL,BR,P0,LU,initialCrack,sizemap,varargin)
