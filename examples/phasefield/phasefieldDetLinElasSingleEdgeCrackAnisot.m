...
PFmodel = 'AnisotropicHe'; % 'AnisotropicHe'
isotropicTest = false; % 'true' or 'false'. For comparison purposes

filename = ['phasefieldDetLinElasAnisotSingleEdgeCrack' loading PFmodel '_' num2str(Dim) 'D'];
if test
...
if setProblem
    ...
    % gc = 2.7e3;
    gc = 10e3; % [N/m] [Nguyen, Yvonnet, Waldmann, He, 2020, IJNME]
    if isotropicTest
        gc = 2.7e3;
    end
    ...
    l = 8.5e-6; % [m] [Nguyen, Yvonnet, Waldmann, He, 2020, IJNME]
