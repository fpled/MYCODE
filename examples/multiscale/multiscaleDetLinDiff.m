...
if setProblem
    ...
    for k=1:n
        ...
        [interfaces.interfaces{k}.P_globOut,numnodeOut] = calcProjection(globOut,interfaces.interfaces{k});
        ...
        % plotProjectionOperator(globOut,patches.patches{k},numnodeOut);
    end
