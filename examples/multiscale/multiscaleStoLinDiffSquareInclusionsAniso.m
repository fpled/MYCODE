%% Multiscale stochastic linear diffusion problem with n square inclusions - Anisotropic case %%
%%--------------------------------------------------------------------------------------------%%
...
filename = ['linDiff' num2str(n) 'SquareInclusionsAniso'];
...
if setProblem
    ...
    glob_out.b = bodyload(glob_out.S,[],'QN',f);
