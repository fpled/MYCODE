...
N = 100; % number of independent realizations for each Gaussian random field
...
if displayPdf
    ...
    set(gca,'FontSize',fontsize)
    mysaveas(pathname,'distribution_Shinozuka_std',formats,renderer);
    ...
    % legend('Numerical estimation','Analytical computation')
    set(gca,'FontSize',fontsize)
    mysaveas(pathname,'distribution_Shinozuka_rand',formats,renderer);
end
