...
if solveProblem
    ...
    switch lower(meshtype)
        ...
        case 'unstructured'
            ...
            S_plate = build_model(Q,'cl',cl_plate,'elemtype',elemtype,'filename',fullfile(pathname,['gmsh_plate_rect_' elemtype]),'points',points);
    end
    ...
    load(fullfile(pathname,'solution.mat'),'u');
