...
%     L2 = 1955e-3;
    ...
    S_guardrailsidepost = convertelem(S_guardrailsidepost,elemtype,'param',VECTOR([1;0;0]));
    ...
    S_guardrailendpost = convertelem(S_guardrailendpost,elemtype,'param',VECTOR([0;1;0]));
