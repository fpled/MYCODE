function varargout = gmshFCBAdesk3pointload(Q,I,L1,L2,PbQ,PiQeI,PiI,clQ,clI,clL1,clL2,clPbQ,clPiQeI,clPiI,filename,indim,varargin)
% function varargout = gmshFCBAdesk3pointload(Q,I,L1,L2,PbQ,PiQeI,PiI,clQ,clI,clL1,clL2,clPbQ,clPiQeI,clPiI,filename,indim,varargin)
% Q : QUADRANGLE
...
if nargin<15
    filename = 'gmsh_desk_3_pointload';
end
if nargin<14
    clPiI = clI;
end
