...
G = createcurveloop(G,[numlines(5:7) -numlines(2)],numlineloop(2));
...
G = createcurveloop(G,[numlines(8:10) -numlines(6)],numlineloop(3));
...
G = createcurveloop(G,[numlines(4) -numlines(11) numlines(9) -numlines(12)],numlineloop(4));
G = createplanesurface(G,numlineloop(4),numsurface(4));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(4));
end

G = createcurveloop(G,numlines([1 5 8 11]),numlineloop(5));
G = createplanesurface(G,numlineloop(5),numsurface(5));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(5));
end

G = createcurveloop(G,numlines([3 12 10 7]),numlineloop(6));
...
G = createcurveloop(G,[numlines([1 5 8 11]) -5 numlines(12)],numlineloop(5));
G = createplanesurface(G,numlineloop(5),numsurface(5));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(5));
end

G = createcurveloop(G,numlines([3 13 10 7]),numlineloop(6));
G = createplanesurface(G,numlineloop(6),numsurface(6));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(6));
end

G = createcurveloop(G,[-numlines(12) 2 -7 -6 -numlines(11) numlines(9) -numlines(13) numlines(4)],numlineloop(4));
...
G = createcurveloop(G,[numlines(9:11) -numlines(7)],numlineloop(3));
G = createplanesurface(G,numlineloop(3),numsurface(3));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(3));
end
...
G = createcurveloop(G,numlines([12 10 13 4]),numlineloop(4));
G = createplanesurface(G,numlineloop(4),numsurface(4));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(4));
end

G = createcurveloop(G,[numlines([1 5]) -11 numlines(6) numlines(9) -numlines(12)],numlineloop(5));
G = createplanesurface(G,numlineloop(5),numsurface(5));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(5));
end

G = createcurveloop(G,[numlines(3) -numlines(13) numlines([11 8])],numlineloop(6));
G = createplanesurface(G,numlineloop(6),numsurface(6));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(6));
end

G = createcurveloop(G,[[numlines(2) -numlines(8):-numlines(6)] 9 -12 4 -numlines(5)],numlineloop(2));
...
G = createcurveloop(G,[numlines(11:13) -numlines(9)],numlineloop(4));
G = createplanesurface(G,numlineloop(4),numsurface(4));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(4));
end
...
G = createcurveloop(G,[numlines(14:16) -numlines(12)],numlineloop(5));
G = createplanesurface(G,numlineloop(5),numsurface(5));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(5));
end
...
G = createcurveloop(G,[numlines(17:19) -numlines(15)],numlineloop(6));
G = createplanesurface(G,numlineloop(6),numsurface(6));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(6));
end
...
G = createcurveloop(G,[numlines(20:22) -numlines(18)],numlineloop(7));
...
G = createcurveloop(G,[numlines(23:25) -numlines(21)],numlineloop(8));
...
G = createcurveloop(G,[numlines(26:28) -numlines(24)],numlineloop(9));
...
G = createcurveloop(G,[numlines(29:31) -numlines(27)],numlineloop(10));
...
G = createcurveloop(G,[numlines(32:34) -numlines(30)],numlineloop(11));
...
G = createcurveloop(G,[numlines(35:37) -numlines(33)],numlineloop(12));
...
G = createcurveloop(G,[numlines(38:40) -numlines(36)],numlineloop(13));
...
G = createcurveloop(G,[numlines(41:43) -numlines(39)],numlineloop(14));
...
G = createcurveloop(G,[numlines(44:46) -numlines(42)],numlineloop(15));
...
G = createcurveloop(G,[numlines(47:49) -numlines(45)],numlineloop(16));
...
G = createcurveloop(G,[numlines(50:52) -numlines(48)],numlineloop(17));
...
G = createcurveloop(G,[numlines(53:55) -numlines(51)],numlineloop(18));
...
G = createcurveloop(G,[numlines(56:58) -numlines(54)],numlineloop(19));
...
G = createcurveloop(G,[numlines(59) -numlines(4) numlines(60) -numlines(57)],numlineloop(20));
G = createplanesurface(G,numlineloop(20),numsurface(20));
if ischarin('recombine',varargin)
    G = recombinesurface(G,numsurface(20));
end

G = createcurveloop(G,numlines([1 5:3:59]),numlineloop(21));
...
G = createcurveloop(G,numlines([60 58:-3:7 3]),numlineloop(25));
