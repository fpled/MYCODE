...
%     for i=1:2
%         plotAllSolutionsReference(glob,patches,interfaces,U_ref,w_ref,lambda_ref,'displ',i);
%     end
% end
...
for i=1:2
    ...
    mysaveas(pathname,['global_local_solution_surf' num2str(i)],formats,renderer);
end
