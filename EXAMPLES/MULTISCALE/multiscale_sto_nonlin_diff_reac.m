...
for k=1:n
    ...
    % K2_patch{k} = double(squeeze(f(patch.S.node))) * X_K2{patch.number};
...
%% Monte Carlo error estimation of reference solution

nbsamples = 100;
if calc_MC_error_estimate_ref && exist('U_ref','var')
